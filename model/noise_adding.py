...
"""
    it takes the original image and it finds out the noisifyed images at the timestep mentioned in array
    (for that we have formula of how to find the t th noisifyed image from the original image)
...
# a batch by repeating the same image many times
...
#  a noisifed version of the image for each noise level
